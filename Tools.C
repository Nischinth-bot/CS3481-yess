...
{
    if(sign(op1) == 0 && sign(op2) == 0) return (sign(op1 + op2) == 1);
    if(sign(op1) == 1 && sign(op2) == 1) return (sign(op1 + op2) == 0);
    return false;
}
...
{
    if(sign(op1) == 0 && sign(op2) == 1) return (sign(op2 - op1) == 0);
    if(sign(op1) == 1 && sign(op2) == 0) return (sign(op2 - op1) == 1);
    return false;
}
